...
- __PhD project__: _Point Spread Function Modelling for Space Telescopes with a Differentiable Optical Model._
    - Project details [here](/assets/opportunities/2026_PhD_subject_PSF.pdf).
    - Start date: 1st October 2026
    - Deadline to apply: 1st April 2026
    - Co-supervision: [Jérôme Bobin](https://scholar.google.com/citations?user=2IWDmk8AAAAJ&hl=en&oi=ao)
    - To apply send application documents to [tobias.liaudat@cea.fr](mailto:tobias.liaudat@cea.fr) and [jerome.bobin@cea.fr](mailto:jerome.bobin@cea.fr) with an email subject starting with [PhD-PSF].
